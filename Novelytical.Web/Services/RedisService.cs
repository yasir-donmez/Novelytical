...
public class RedisService : IRedisService
{
    ...
    public async Task IncrementAsync(string key, long value = 1)
    {
        ...
        {
            _logger.LogError(ex, "Redis IncrementAsync failed for key: {Key}", key);
            throw;
        }
    }
    ...
    public async Task SetAsync(string key, long value, TimeSpan? expiry = null)
    {
        ...
        {
            _logger.LogError(ex, "Redis SetAsync (long) failed for key: {Key}", key);
            throw;
        }
    }
    ...
    public async Task SetAsync(string key, string value, TimeSpan? expiry = null)
    {
        ...
        {
            _logger.LogError(ex, "Redis SetAsync (string) failed for key: {Key}", key);
            throw;
        }
    }
    ...
    public async Task SetAddAsync(string key, string value)
    {
        ...
        {
            _logger.LogError(ex, "Redis SetAddAsync failed for key: {Key}", key);
            throw;
        }
    }
    ...
    public async Task SetRemoveAsync(string key, string value)
    {
        ...
        {
            _logger.LogError(ex, "Redis SetRemoveAsync failed for key: {Key}", key);
            throw;
        }
    }
    ...
    public async Task<string[]> SetMembersAsync(string key)
    {
        ...
        {
            _logger.LogError(ex, "Redis SetMembersAsync failed for key: {Key}", key);
    ...
    public async Task ListLeftPushAsync(string key, string value)
    {
        ...
        {
            _logger.LogError(ex, "Redis ListLeftPushAsync failed for key: {Key}", key);
            throw;
        }
    }
    ...
    public async Task<string[]> ListRangeAsync(string key, long start, long stop)
    {
        ...
        {
            _logger.LogError(ex, "Redis ListRangeAsync failed for key: {Key}", key);
            return Array.Empty<string>();
        }
    }
    ...
    public async Task ListTrimAsync(string key, long start, long stop)
    {
        ...
        {
            _logger.LogError(ex, "Redis ListTrimAsync failed for key: {Key}", key);
            throw;
        }
    }
    ...
    public async Task SortedSetAddAsync(string key, string member, double score)
    {
        ...
        {
            _logger.LogError(ex, "Redis SortedSetAddAsync failed for key: {Key}", key);
            throw;
        }
    }
    ...
    public async Task<string[]> SortedSetRangeByRankAsync(string key, long start, long stop, bool descending = false)
    {
        ...
        {
            _logger.LogError(ex, "Redis SortedSetRangeByRankAsync failed for key: {Key}", key);
            return Array.Empty<string>();
        }
    }
    ...
    public async Task SortedSetRemoveRangeByRankAsync(string key, long start, long stop)
    {
        ...
        {
            _logger.LogError(ex, "Redis SortedSetRemoveRangeByRankAsync failed for key: {Key}", key);
            throw;
        }
    }
    ...
    public async Task<long> SortedSetLengthAsync(string key)
    {
        ...
        {
            _logger.LogError(ex, "Redis SortedSetLengthAsync failed for key: {Key}", key);
            return 0;
        }
    }
}
